...
export const DataTable2 = `
	.data-table{${scrollbar}
		overflow-x:auto; 
		table {min-width: 100%;
			th{ color:#111111;font-size:1.6rem;height:4rem;background:#ECEEF5; white-space:nowrap;padding:0.5rem 1rem; vertical-align:middle;}
			td{ color:#383838;font-size:1.4rem;height:4rem; vertical-align:middle;white-space:nowrap;padding:0.5rem 1rem;text-align:center;}
		}
	}
`
