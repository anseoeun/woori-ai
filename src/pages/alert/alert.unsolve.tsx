...
const _ = () => {
	...
	const [popSolve, setPopSolve] = useState<boolean>(true)
	...
	return (
			...
			<div className='danger-unsolve-wrap'>
				<div className='page-top-area'>
					...
					<div className='btn-wrap'>
						<button className='btn-img-view' onClick={() => { popOpenPhotoView() }}>이미지 열람</button>
					</div>
				</div>
		...
		<PopSolveConfirm title='위험 알림 해결' data={alertRow} open={popSolve} close={() => setPopSolve(false)} />
