...
const PublishingMenuList: Array<MenuProps> = [
	...
	{ category: '등록', depth1: '', depth2: '', depth3: '', path: '/publish/schedule/register', realpath: '/schedule/edit', memo: '' },
	...
	{ category: '수정', depth1: '', depth2: '', depth3: '', path: '/publish/class/modify', realpath: '/class/edit', memo: '' },
	...
	{ category: '수정확인', depth1: '', depth2: '', depth3: '', path: '/publish/child/home', realpath: '/child/edit/check', memo: '' },
